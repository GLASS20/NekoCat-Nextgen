...
import link.liycxc.pvp.management.mods.impl.MinimalBobbingMod;
import link.liycxc.pvp.management.mods.impl.MinimalDamageShakeMod;
import link.liycxc.pvp.management.mods.impl.MotionBlurMod;
import link.liycxc.pvp.management.mods.impl.OldAnimationsMod;
import link.liycxc.utils.shader.MotionBlurUtils;
        ...
        if (entity != null && this.mc.theWorld != null) {
            ...
            for (int j = 0; j < list.size(); ++j) {
                ...
                if (axisalignedbb.isVecInside(vec3)) {
                    ...
                    if (d3 < d2 || d2 == 0.0D) {
                        if (entity1 == entity.ridingEntity && !(false)) {
                            if (d2 == 0.0D) {
                                this.pointedEntity = entity1;
...
*/
    ...
    private void hurtCameraEffect(float partialTicks) {
//        if (Harmony.moduleManager.getModule(NoHurtCam.class).getState()) {
//            return;
//        }
    ...
    public void renderHand(float p_renderHand_1_, int p_renderHand_2_, boolean p_renderHand_3_, boolean p_renderHand_4_, boolean p_renderHand_5_) {
        if(mc.thePlayer != null && NekoCat.instance.modManager.getModByClass(OldAnimationsMod.class).isToggled() &&
                ...
                || mc.thePlayer.swingProgressInt >= (mc.thePlayer).accessArmSwingAnimationEnd()
