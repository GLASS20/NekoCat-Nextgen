...
public class EventRendererLivingEntity extends Event {
    ...
    public EventRendererLivingEntity(EntityLivingBase entity, Event.State type, float limbSwing, float limbSwingAmount, float ageInTicks, float rotationYawHead, float rotationPitch, float chestRot, float offset) {
        this.entity = entity;
        this.type = type;
    ...
    public EventRendererLivingEntity(EntityLivingBase entity, Event.State type) {
        this.entity = entity;
        this.type = type;
        this.limbSwing = 0;
    ...
    public boolean isPost() {
        return this.type == Event.State.POST;
    }
