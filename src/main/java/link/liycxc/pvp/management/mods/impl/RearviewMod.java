...
import link.liycxc.api.events.impl.EventRenderTick;
...
import link.liycxc.utils.render.RenderGlobalHelper;
...
public class RearviewMod extends Mod {
	...
	public void onRenderTick(EventRenderTick event) {
		...
		int fps = NekoCat.instance.settingsManager.getSettingByName(this, "FPS").getValInt();
	...
	public void onRender2D(EventRender2D event) {
		...
		int width = NekoCat.instance.settingsManager.getSettingByName(this, "Width").getValInt();
		int height = NekoCat.instance.settingsManager.getSettingByName(this, "Height").getValInt();
    ...
    private void updateMirror() {
        ...
        long endTime = 0;
        float fov;
        boolean lockCamera = NekoCat.instance.settingsManager.getSettingByName(this, "Lock Camera").getValBoolean();
        boolean damageShake;
        ...
        damageShake = NekoCat.instance.modManager.getModByClass(MinimalDamageShakeMod.class).isToggled();
        ...
        mc.gameSettings.fovSetting = NekoCat.instance.settingsManager.getSettingByName(this, "Fov").getValFloat();

        if(!damageShake) {
        	if(!NekoCat.instance.settingsManager.getSettingByName(this, "Damage Shake").getValBoolean()) {
            	NekoCat.instance.modManager.getModByClass(MinimalDamageShakeMod.class).setToggled(true);
        	}
        }else {
        	NekoCat.instance.modManager.getModByClass(MinimalDamageShakeMod.class).setToggled(false);
        }
    	...
    	NekoCat.instance.modManager.getModByClass(MinimalDamageShakeMod.class).setToggled(damageShake);
