...
public class ReachCirclesMod extends Mod {
    ...
    private void circle(double x, double y, double z, double rad) {
        GL11.glPushMatrix();
        Color color = NekoCat.instance.settingsManager.getSettingByName(this, "Accent Color").getValBoolean() ? ColorUtils.getClientColor(0) : new Color(255, 255, 255);
        
        GL11.glLineWidth((float) NekoCat.instance.settingsManager.getSettingByName(this, "Width").getValDouble());
