package link.liycxc.pvp.management.mods;
...
import link.liycxc.utils.render.OutlineUtils;
...
public class Mod {
	...
	public void addBooleanSetting(String name, Mod mod, boolean toggle) {
		NekoCat.instance.settingsManager.addSetting(new Setting(name, mod, toggle));
	}
	
	public void addModeSetting(String name, Mod mod, String defaultMode, ArrayList<String> options) {
		NekoCat.instance.settingsManager.addSetting(new Setting(name, mod, defaultMode, options));
	}
	
	public void addSliderSetting(String name, Mod mod, double defaultValue, double minValue, double maxValue, boolean intValue) {
		NekoCat.instance.settingsManager.addSetting(new Setting(name, mod, defaultValue, minValue, maxValue, intValue));
	}
	
	public void drawBackground(float x, float y, float width, float height) {
		int opacity = (int) (NekoCat.instance.settingsManager.getSettingByClass(HUDMod.class, "Opacity").getValDouble() * 255);
		int radius = NekoCat.instance.settingsManager.getSettingByClass(HUDMod.class, "Radius").getValInt();
		String mode = NekoCat.instance.settingsManager.getSettingByClass(HUDMod.class, "Design").getValString();
		
		if(NekoCat.instance.settingsManager.getSettingByClass(HUDMod.class, "Background").getValBoolean()) {
			switch(mode) {
				case "Color":
	...
	public void drawShadow(float x, float y, float width, float height) {
		...
		if(NekoCat.instance.settingsManager.getSettingByClass(HUDMod.class, "Shadow").getValBoolean()) {
