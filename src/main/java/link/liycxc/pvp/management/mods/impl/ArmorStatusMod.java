...
public class ArmorStatusMod extends Mod {
	...
	public void onRender2D(EventRender2D event) {
        ...
        int x;
        int y;
        int addHeldItem = NekoCat.instance.settingsManager.getSettingByName(this, "Held Item").getValBoolean() ? 16 : 0;
        ...
        if(NekoCat.instance.settingsManager.getSettingByName(this, "Held Item").getValBoolean()) {
            GL11.glPushMatrix();
    ...
    private void renderArmorStatus(final ScaledResolution sr, final int pos, final ItemStack itemStack) {
        ...
        if(NekoCat.instance.settingsManager.getSettingByName(this, "Endurance Value").getValBoolean()) {
            GL11.glPushMatrix();
            RenderHelper.enableGUIStandardItemLighting();
