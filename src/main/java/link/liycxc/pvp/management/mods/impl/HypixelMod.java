...
public class HypixelMod extends Mod {
	...
	public void onTick(EventTick event) {
		if(NekoCat.instance.settingsManager.getSettingByName(this, "Auto Tip").getValBoolean()) {
	...
	public void onUpdate(EventUpdate event) {
		...
		int delay = (int) NekoCat.instance.settingsManager.getSettingByName(this, "Delay").getValDouble();

		if(ServerUtils.isHypixel()) {
			if(NekoCat.instance.settingsManager.getSettingByName(this, "Auto GG").getValBoolean()) {
				if(this.autogg == true) {
			...
			if(NekoCat.instance.settingsManager.getSettingByName(this, "Auto Play").getValBoolean()) {
