...
public class PlayerDisplayMod extends Mod {
	...
	public void onRender2D(EventRender2D event) {
		...
		float raw = NekoCat.instance.settingsManager.getSettingByName(this, "Scale").getValFloat();
		float scale = NekoCat.instance.settingsManager.getSettingByName(this, "Scale").getValFloat() * 30;
		float yawOffset = NekoCat.instance.settingsManager.getSettingByName(this, "Yaw Offset").getValFloat();
