...
public class ScoreboardMod extends Mod {
	...
	public void onRenderScoreboard(EventRenderScoreboard event) {
		...
		boolean showNumber = NekoCat.instance.settingsManager.getSettingByName(this, "ShowNumber").getValBoolean();
	...
	public void onRenderShadow(EventRenderShadow event) {
        ...
        if (scoreobjective1 != null && NekoCat.instance.settingsManager.getSettingByName(this, "Shadow").getValBoolean())
        {
