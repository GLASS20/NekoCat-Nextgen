...
import link.liycxc.api.events.impl.EventRenderHitbox;
...
public class HitboxMod extends Mod {
	...
	public void onRenderHitbox(EventRenderHitbox event) {
		...
		boolean boundingBox = NekoCat.instance.settingsManager.getSettingByName(this, "Bounding box").getValBoolean();
		boolean eyeHeight = NekoCat.instance.settingsManager.getSettingByName(this, "Eye Height").getValBoolean();
		boolean lookVector = NekoCat.instance.settingsManager.getSettingByName(this, "Look Vector").getValBoolean();
		int lineWidth = NekoCat.instance.settingsManager.getSettingByName(this, "Line Width").getValInt();
