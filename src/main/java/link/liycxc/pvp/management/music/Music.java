package link.liycxc.pvp.management.music;
...
import link.liycxc.pvp.management.mods.impl.MusicInfoMod;
...
public class Music {
	...
	public void playMusic() {
		...
		if(NekoCat.instance.modManager.getModByName("Music Info").isToggled()) {
	...
	public void setVolume() {
		mediaPlayer.setVolume(NekoCat.instance.settingsManager.getSettingByClass(ClientMod.class, "Volume").getValDouble());
	}
