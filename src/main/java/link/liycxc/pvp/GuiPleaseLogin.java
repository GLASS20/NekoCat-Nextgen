...
public class GuiPleaseLogin extends GuiScreen{
	...
	public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
			...
			new Thread() {
				...
				public void run() {
					...
					try {
						...
						close = true;
						NekoCat.instance.accountManager.isFirstLogin = false;
		...
		if(MouseUtils.isInside(mouseX, mouseY, x + 35, y + 91, 100, 20)) {
			...
			close = true;
			NekoCat.instance.accountManager.isFirstLogin = false;
			NekoCat.instance.accountManager.setCurrentAccount(NekoCat.instance.accountManager.getAccountByUsername(username));
			NekoCat.instance.accountManager.save();
		}
