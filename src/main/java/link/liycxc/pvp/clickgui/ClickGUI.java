package link.liycxc.pvp.clickgui;

import link.liycxc.NekoCat;
import link.liycxc.api.events.EventTarget;
import link.liycxc.api.events.impl.EventRenderShadow;
import link.liycxc.pvp.GuiSearchField;
import link.liycxc.pvp.clickgui.category.Category;
import link.liycxc.pvp.clickgui.category.CategoryManager;
import link.liycxc.pvp.clickgui.category.impl.CosmeticCategory;
import link.liycxc.pvp.clickgui.category.impl.FeatureCategory;
import link.liycxc.pvp.clickgui.category.impl.MusicPlayerCategory;
import link.liycxc.pvp.clickgui.category.impl.SettingsCategory;
...
public class ClickGUI extends GuiScreen{
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		FontUtils.regular_bold36.drawStringWithClientColor("NekoCat", x + 8, y + 6, false);
	...
	public void onGuiClosed() {
		if(NekoCat.instance.fileManager != null) {
			NekoCat.instance.configManager.save();
		}
	}
