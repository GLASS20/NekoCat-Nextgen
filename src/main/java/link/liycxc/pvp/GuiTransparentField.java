...
public class GuiTransparentField extends Gui
{
    ...
    public GuiTransparentField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, int color)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = FontUtils.regular20.drawString(s1, (float)l, (float)i1, color);
            }
            ...
            {
                j1 = FontUtils.regular20.drawString(s.substring(j), (float)j1, (float)i1, color);
            }
            ...
            if (flag1)
            {
                ...
                {
                	FontUtils.regular20.drawString("_", (float)k1, (float)i1, color);
                }
            }
