package link.liycxc.pvp.credit;
...
public class GuiCredit extends GuiScreen{
	...
	public GuiCredit() {
		...
		credits.add(new Credit("TheKodeToad", "Motion blur on NekoCat and some code help", "https://github.com/TheKodeToad", "S"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if(close) {
			...
			if(introAnimation.isDone(Direction.BACKWARDS)) {
				mc.displayGuiScreen(NekoCat.instance.guiManager.getGuiMainMenu());
			}
		}
