...
public class GuiSearchField extends Gui
{
    ...
    public GuiSearchField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            int i1 = this.enableBackgroundDrawing ? this.yPosition + (this.height - 18) / 2 : this.yPosition;
            int j1 = l;
            ...
            if (s.length() > 0)
            {
                ...
                j1 = FontUtils.regular20.drawString(s1, (float)l, (float)i1 + NekoCat.instance.guiManager.getClickGUI().searchAnimation.getValue(), ColorUtils.getFontColor(2).getRGB());
            }
            ...
            {
                j1 =  FontUtils.regular20.drawString(s.substring(j), (float)j1, (float)i1 + NekoCat.instance.guiManager.getClickGUI().searchAnimation.getValue(),  ColorUtils.getFontColor(2).getRGB());
            }
            ...
            if (flag1)
            {
                ...
                {
                	 FontUtils.regular20.drawString("_", (float)k1, (float)i1 + NekoCat.instance.guiManager.getClickGUI().searchAnimation.getValue(),  ColorUtils.getFontColor(2).getRGB());
                }
            }

            if (k != j)
            {
                int l1 = (int) (l +  FontUtils.regular20.getStringWidth(s.substring(0, k)));
