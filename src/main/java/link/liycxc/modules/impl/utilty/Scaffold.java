...
import link.liycxc.utils.player.*;
import link.liycxc.api.events.impl.*;
...
import link.liycxc.manages.component.impl.BlinkComponent;
...
import link.liycxc.utils.invs.SlotUtil;
import link.liycxc.utils.player.*;
import link.liycxc.utils.vector.Vector2f;
import link.liycxc.utils.vector.Vector3d;
...
public class Scaffold extends Module {
    ...
    public void onPreUpdate(EventPreUpdate event) {
        ...
        // Same Y
        final boolean sameY = ((!"Off".equals(this.sameY.get()) || NekoCat.instance.moduleManager.getModule("Speed").getToggled()) && !mc.gameSettings.keyBindJump.isKeyDown()) && MoveUtil.isMoving();
