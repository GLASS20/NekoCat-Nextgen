package link.liycxc.utils.shader;
...
public class BlurUtils {
    ...
    public static void drawBlurScreen() {
        ...
        (blurShader).getListShaders().get(0).getShaderManager().getShaderUniform("Radius").set((int) NekoCat.instance.settingsManager.getSettingByClass(MenuBlurMod.class, "Radius").getValDouble());
        (blurShader).getListShaders().get(1).getShaderManager().getShaderUniform("Radius").set((int) NekoCat.instance.settingsManager.getSettingByClass(MenuBlurMod.class, "Radius").getValDouble());
