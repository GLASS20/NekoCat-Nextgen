package link.liycxc.utils.wing;

import link.liycxc.NekoCat;
import link.liycxc.pvp.management.mods.impl.WingsMod;
...
public class WingModel extends ModelBase implements LayerRenderer<AbstractClientPlayer>{
    ...
    public void renderWing(AbstractClientPlayer player) {
        if (NekoCat.instance.modManager.getModByClass(WingsMod.class).isToggled()) {
