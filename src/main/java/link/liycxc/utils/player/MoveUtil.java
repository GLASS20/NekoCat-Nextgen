...
import link.liycxc.api.events.impl.EventMove;
import link.liycxc.api.events.impl.EventMoveInput;
import link.liycxc.utils.PlayerUtils;
import link.liycxc.utils.vector.Vector2d;
...
public class MoveUtil {
    ...
    public void setMoveEvent(final EventMove moveEvent, final double moveSpeed) {
