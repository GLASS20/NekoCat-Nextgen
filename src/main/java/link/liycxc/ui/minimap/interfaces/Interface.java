    ...
    public Interface(final String name, final int w, final int h, final int wc, final int hc) {
        ...
        this.cBox = new CursorBox(2) {
            ...
            public String getString(final int line) {
                switch (line) {
                    case 0: {
                        return I18n.format(Interface.this.iname, new Object[0]);
                    }
                    case 1: {
                        return I18n.format("gui.xaero_centered", new Object[0]) + " " + Interface.this.centered + " " + I18n.format("gui.xaero_press_c", new Object[0]);
                    }
                    default: {
                        return "";
                    }
