package link.liycxc.ui.minimap.interfaces;

import link.liycxc.NekoCat;
import link.liycxc.ui.minimap.XaeroMinimap;
import link.liycxc.ui.minimap.minimap.Minimap;
import link.liycxc.pvp.management.mods.impl.MinimapMod;
    ...
    public static void load() {
        InterfaceHandler.minimap = new Minimap(new Interface("gui.xaero_minimap", 128, 128) {
            ...
            public void drawInterface(final int width, final int height, final int scale, final float partial) {
                ...
                InterfaceHandler.mc.ingameGUI.drawTexturedModalRect(NekoCat.instance.modManager.getModByClass(MinimapMod.class).getX(), NekoCat.instance.modManager.getModByClass(MinimapMod.class).getY(), 0, 0, (int)((mapW / 2 + 1) / sizeFix), (int)((mapH / 2 + 1) / sizeFix));
